                    ...
                    if (orderNum == 1) {
                        while (true) {// 할인 정보 제공
                            ...
                            if (discountChoice == 0) {
                                ...
                                break;
                            } else if (discountChoice > 0 && discountChoice < 5) {
                                switch (discountChoice) {
                                    case 1:
                                        discountCategory = DiscountCategory.국가유공자;
                                        break;
                                    case 2:
                                        discountCategory = DiscountCategory.군인;
                                        break;
                                    case 3:
                                        discountCategory = DiscountCategory.학생;
                                        break;
                                    case 4:
                                        discountCategory = DiscountCategory.일반인;
                                        break;
                                    default:
                                        System.out.println("잘못된 값을 입력하였습니다.");
                                }
